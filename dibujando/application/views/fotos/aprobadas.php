                        ...
                        <table width="172" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <tr>
                              ...
                              <td bgcolor="#D6D6D6"  ><div align="center"><a href="/upload/<?=$aprobada['foto']?>" id="foto<?=$aprobada['idfoto']?>"><img src="/upload/chicas/<?=$aprobada['foto']?>" width="150" height="113" border="0"/></a></div></td>
                            ...
                            <tr>
                              <td colspan="3"><div align="center"><a href="/fotos/desaprueba/<?=$aprobada['idfoto']?>/2/<?=$pagina?>/">
                                <input type="button" name='button' value='No Aprobar' class="botonnoaprobar">
                              </a></div></td>
                            </tr>
                            <tr>
                              <td colspan="3">&nbsp;</td>
