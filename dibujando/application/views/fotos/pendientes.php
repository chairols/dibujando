  ...
  <tr>
    <td bgcolor="#FFFFFF"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td rowspan="14"><div align="center">
          <?php
        $k = 0;
        if(count($fotos) > 0) {
        ...
        ?>
          <a href="/upload/<?=$fotos[$k]['foto']?>" rel="lightbox[roadtrip]"><img src="/upload/<?=$fotos[$k]['foto']?>" width="640" height="480"  alt=""/></a>
          <?php } ?>
        </div></td>
      </tr>
      <tr>
        <td><a href="/fotos/no-aprobadas/" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image97','','/assets/imagenes/fotosnoaprobadas2.jpg',1)"><img src="/assets/imagenes/fotosnoaprobadas1.jpg" alt="" width="208" height="43" id="Image97"></a></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><div align="center">
          <table width="30%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <?php if(count($fotos)) { ?>
              <td><a href="/fotos/aprueba/<?=$fotos[$k]['idfoto']?>/2/"><img src="/assets/imagenes/no.jpg" width="50" height="56"  alt=""/></a></td>
              <td><div align="right"><a href="/fotos/aprueba/<?=$fotos[$k]['idfoto']?>/1/"><img src="/assets/imagenes/ok.jpg" width="50" height="56"  alt=""/></a></div></td>
                <?php } ?>
              </tr>
            </table>
          </div></td>
