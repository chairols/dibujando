...
<table width="950" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td bgcolor="#FFFFFF"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td width="202">&nbsp;</td>
        <td width="701"><div align="right"><span class="bienvenido"></span></div></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <td rowspan="74"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="10">
                <?php
      $i = 0;
                        ...
                        <table width="172" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <tr>
                              ...
                              <td bgcolor="#D6D6D6" style="height: 200px" ><div align="center"><a href="/upload/<?=$aprobada['foto']?>" id="foto<?=$aprobada['idfoto']?>"><img src="/upload/chicas/<?=$aprobada['foto']?>" width="150" height="113" border="0"/></a></div></td>
                            ...
                            <tr>
                              <td colspan="3"><div align="center"><a href="/fotos/vot/<?=$aprobada['idfoto']?>">
                                <input type="button" name='button' value='Votar' class="botonnoaprobar">
                              </a></div></td>
                            </tr>
                            <tr>
                              <td colspan="3">&nbsp;</td>
