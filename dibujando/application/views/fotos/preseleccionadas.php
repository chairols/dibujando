  ...
  <tr>
    <td bgcolor="#FFFFFF"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td rowspan="14"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                <form method="post">
            <tr>
            <td><span class="seleccionar">Seleccionar</span>
                ...
                <td>
                  <div align="center" class="seleccionar">
                    <table width="172" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td colspan="3"><div align="center">Puntaje:
                          <?=round($foto['promedio'], 2)?>
                          </div></td>
                        </tr>
                      <tr>
                        <td colspan="3">&nbsp;</td>
      ...
      <tr>
        <td>&nbsp;</td>
        <td><div align="center"><span class="seleccionar">Esta seguro de aceptar estas <?=count($fotos)?> fotos? </span>
                <form method="post">
                    <input type="hidden" name="limite" value="<?=$limit?>">
                    <input type="hidden" name="tipo" value="preseleccionar">
