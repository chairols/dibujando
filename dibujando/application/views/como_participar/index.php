...
<table width="950" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td class="fondo2" ><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td class="fondoblanco interiortabla2" width="701" rowspan="20"><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td class="bienvenido"><strong>¿Cómo participar?</strong></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td><ul>
              <li><strong>El concurso está abierto a mayores de 18 años argentinos o residentes en el país.</strong><br>
                <br>
              </li>
              <li><strong>Podés presentar hasta dos fotos tomadas exclusivamente dentro del ámbito de la Ciudad Autónoma de Buenos Aires.</strong><br>
                <br>
              </li>
              <li><strong>Fechas de inscripción: 15 de mayo al 30 de junio</strong><br>
                <br>
              </li>
              <li><strong> Para inscribirte, es importante que leas las bases y condiciones de participación y aceptar términos y condiciones.</strong><br>
                <br>
              </li>
              <li><strong>Votación &ldquo;Gente de mi Ciudad&rdquo;: 20 al 31 de agosto</strong></li>
            </ul>              </td>
          </tr>
          <tr>
            <td>&nbsp;</td>
