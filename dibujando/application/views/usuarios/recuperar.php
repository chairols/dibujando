...
<script type="text/javascript">
    $(document).ready(function() {
        alert("Se ha enviado un correo al email registrado con tus datos de acceso.");
    });
</script>
<?php } ?>
<!doctype html>
    ...
    <td class="fondo7"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td class="fondoblanco interiortabla2" width="701" rowspan="20"><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td><div align="center" class="bienvenido">&nbsp;</div></td>
            </tr>
            <tr>
              <td><div align="center" class="bienvenido"><em>Por favor, ingresá tu email</em></div></td>
              </tr>
            <tr>
              ...
              <td><form role="form" method="post">
                <div align="center">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td><div align="center">
                              <input name="email" type="email" class="campoform" placeholder="Email" autofocus>
                        </div></td>
                      </tr>
                    <tr>
                      <td>&nbsp;</td>
                    ...
                    <tr>
                      <td><div align="center">
                        <button name="button" type="submit" class="enviar">RECUPERAR</button>
                        </div></td>
                      </tr>
                    <tr>
                      <td>&nbsp;</td>
